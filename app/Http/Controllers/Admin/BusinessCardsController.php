...
class BusinessCardsController extends AppBaseController
{
    ...
    public function store(CreateBusinessCardsRequest $request)
    {
        ...
        Flash::success('AI數位名片建立成功！請繼續添加氣泡卡片。');
