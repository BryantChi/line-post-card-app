...
@section('content')
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-12 text-center mt-3">
                    <h5 class="text-7c6796 font-weight-bold mb-3">結合LINE優勢，打造高效AI數位名片</h5>
    ...
    <div class="container-xxl py-5 hp-intro3-bg">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center slick">
                @foreach ($cases ?? [] as $case)
                    <div class="col-lg-4 mb-3">
                        <a href="{{ $case->businessCard->getShareUrl() }}" target="_blank" class="text-decoration-none">
                            <img src="{{ asset('uploads/' . $case->businessCard->profile_image) }}" class="img-fluid rounded-10"
                            alt="">
                        </a>
                    </div>
                @endforeach
            ...
            <div class="row py-lg-5 py-3">
                <div class="col-lg-10 col-md-6">
                    ...
                    <a href="https://lin.ee/HnB194r" target="_blank">
                        <img src="{{ asset('assets/images/00-hp/bu_line.svg') }}" class="img-fluid" width="230px"
                            alt="">
                    </a>
                </div>
        ...
        <div class="container-fluid px-lg-5 mx-lg-5 px-md-3 mx-md-3 px-2 mx-2">
            <div class="row py-5 align-items-center">
                ...
                <div class="col-lg col-md-8">
                    <p class="text-white font-weight-normal line-height-2" style="font-size: smaller;">
