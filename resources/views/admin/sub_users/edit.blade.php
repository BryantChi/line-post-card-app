...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($subUser, ['route' => ['sub-users.update', $subUser->id], 'method' => 'patch']) !!}

            <div class="card-body">
                <div class="row">
                    @include('admin.sub_users.fields')
                </div>
            </div>

            <div class="card-footer">
                {!! Form::submit('儲存', ['class' => 'btn btn-primary']) !!}
                <a href="{{ route('sub-users.index') }}" class="btn btn-default">取消</a>
            </div>
