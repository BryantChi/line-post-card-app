    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-info float-right" id="start-create-template-tour">
...
@push('page_scripts')
    ...
    <script @cspNonce>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const tourButton = document.getElementById('start-create-template-tour');
            if (tourButton) {
                tourButton.addEventListener('click', startCreateTemplateTour);
            }
        });
    </script>
@endpush
