<!-- 標題 Field -->
<div class="form-group col-sm-6" data-step="1" data-intro="請為您的數位名片設定一個明確的名稱，方便您辨識。">
...
<!-- 頭像/Logo Field -->
<div class="form-group col-sm-6" data-step="3" data-intro="上傳代表此數位名片的頭像或Logo圖片。">
...
<!-- 啟用狀態 Field -->
<div class="form-group col-sm-6" data-step="4" data-intro="勾選此項以啟用此數位名片，使其可被分享和查看。">
    <div class="form-check mt-4">
        {!! Form::hidden('active', 0) !!}
        {!! Form::checkbox('active', '1', isset($businessCard) ? $businessCard->active : true, ['class' => 'form-check-input']) !!}
        {!! Form::label('active', '啟用此數位名片', ['class' => 'form-check-label']) !!}
    </div>
</div>
...
@if(isset($businessCard))
    ...
    <div class="form-group col-sm-12" data-step="6" data-intro="如果您對內含的卡片進行了修改，並希望更新整個數位名片的LINE Flex Message JSON結構，請勾選此項。">
        <div class="form-check">
            ...
            <small class="form-text text-muted">勾選此項將根據現有數位名片-卡片重新生成 Flex JSON 結構</small>
        </div>
    </div>
@endif
