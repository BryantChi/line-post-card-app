...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <div class="card-body" data-step="fields_edit" data-intro="您可以修改以下數位名片的資訊。">
                <div class="row">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('admin.businessCards.bubbles.index', $businessCard->id) }}" class="btn btn-info" data-step="manage_bubbles_edit" data-intro="點擊這裡進入此數位名片的「卡片管理」頁面，您可以新增、編輯或排序卡片。">
...
@push('page_scripts')
    ...
    <script>
        function startEditCardTour() {
            ...
            const stepData = [
                { selector: '[data-step="1"]', defaultIntro: "<strong>卡片名稱：</strong><br>您可以修改數位名片的名稱。" },
                { selector: '[data-step="2"]', defaultIntro: "<strong>副標題：</strong><br>您可以修改或新增數位名片的副標題。" },
                { selector: '[data-step="3"]', defaultIntro: "<strong>頭像/Logo：</strong><br>您可以更換代表此數位名片的頭像或Logo圖片。" },
                { selector: '[data-step="4"]', defaultIntro: "<strong>啟用狀態：</strong><br>您可以修改此數位名片的啟用狀態。" },
                { selector: '[data-step="5"]', defaultIntro: "<strong>簡介內容：</strong><br>您可以修改此數位名片的簡短介紹或說明。" },
                { selector: '[data-step="6"]', defaultIntro: "<strong>重新生成 Flex JSON：</strong><br>如果您對內含的卡片進行了修改，並希望更新整個數位名片的LINE Flex Message JSON結構，請勾選此項。", optional: true },
                ...
                { selector: '[data-step="manage_bubbles_edit"]', defaultIntro: "<strong>管理數位名片-卡片：</strong><br>點擊這裡進入此數位名片的「卡片管理」頁面，您可以新增、編輯或排序卡片。" }
            ];
